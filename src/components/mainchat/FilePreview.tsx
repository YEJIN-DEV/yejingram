...
export const renderFile = (file: FileToSend, preview: boolean) => {
      ...
      <div className="w-64 bg-gradient-to-r from-purple-50 to-blue-50 p-4 rounded-lg border border-purple-200">
        <div className="flex items-center space-x-3 mb-3">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-[var(--color-text-title)]">오디오 파일</p>
            <p className="text-xs text-[var(--color-text-tertiary)]">클릭하여 재생</p>
          </div>
        </div>
        <audio
          controls
  ...
  return (
    <div className="flex flex-col items-center justify-center h-24 bg-[var(--color-button-secondary-accent)] rounded-lg">
      ...
      <span className="text-sm text-[var(--color-text-quaternary)] mt-1">
