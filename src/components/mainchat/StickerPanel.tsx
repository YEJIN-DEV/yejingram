...
export function StickerPanel({ characterId, stickers, onSelectSticker, onClose }: StickerPanelProps) {
    ...
    return (
        <div className="absolute bottom-full left-0 mb-2 w-96 h-96 bg-[var(--color-bg-main)] rounded-2xl shadow-xl border border-[var(--color-border)] animate-fadeIn flex flex-col">
            <div className="p-4 border-b border-[var(--color-border-secondary)] flex items-center justify-between flex-shrink-0">
            ...
            <div className="p-4 flex-1 overflow-y-auto flex flex-col">
                <div className="flex items-center justify-between text-xs text-[var(--color-text-secondary)] mb-4 flex-shrink-0">
                ...
                {stickers.length === 0 ? (
                    <div className="text-center text-[var(--color-icon-tertiary)] py-8 flex-1 flex flex-col justify-center">
