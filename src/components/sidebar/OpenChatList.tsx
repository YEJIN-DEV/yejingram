    ...
    return (
        <div className="mb-4">
            <div className="group flex items-center justify-between px-1 mb-2 relative">
                ...
                <button onClick={openCreateOpenChatModal} className="opacity-0 group-hover:opacity-100 transition-all p-1 bg-gray-700 hover:bg-green-600 rounded text-gray-300 hover:text-white" title="새 오픈톡방">
